...
use AnimeDb\Bundle\WorldArtBrowserBundle\DependencyInjection\Configuration;
...
class ConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConfigTree()
    {
        ...
        $this->assertEquals('anime_db_world_art_browser', $tree->getName());
        ...
        $this->assertEquals('http://www.world-art.ru', $children['host']->getDefaultValue());
